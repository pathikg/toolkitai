      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-base text-gray-600 mb-8 leading-relaxed">
            Sign in to access our AI-powered tools<br />and start creating amazing content.
          </p>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-3.5 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
