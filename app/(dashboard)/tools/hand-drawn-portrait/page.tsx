...
import HandDrawnPortraitClient from './hand-drawn-portrait-client'
import { createClient } from '@/lib/supabase/client'
import { useEffect, useState } from 'react'
import { useRouter } from 'next/navigation'

export default function HandDrawnPortraitPage() {
    ...
    <>
      {!user && (
        <LoginModal
          ...
          redirectAfterLogin="/tools/hand-drawn-portrait"
        />
      )}
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-4xl font-bold text-gray-900">Hand-Drawn Portrait</h1>
            </div>
